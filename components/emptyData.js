...
export default function EmptyData({ text, onPress }) {
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 40 }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: Colors.primary }}>{text}</Text>
            ...
            <Button mode="contained" style={{ ...styles.AddBtn }} buttonColor={Colors.primary} onPress={onPress}>
                Refresh
            </Button>
        </View>
    )
