    ...
    return (
        isLoggedIn ?
                        ...
                        <>
                            ...
                            <View style={styles.container}>
                                <View style={styles.infoContainer}>
                                    <Image
                                        source={{ uri: profile?.avatar ? getImageUrl(profile?.avatar) : 'https://www.pngitem.com/pimgs/m/146-1468479_my-profile-icon-blank-profile-picture-circle-hd.png' }}
                                        style={styles.avatar}
                                    />
            ...
            >
                ...
                <Animated.FlatList
                    data={options.filter(item => !item?.private)}
                    onScroll={
                        Animated.event(
                            [{ nativeEvent: { contentOffset: { y: scrollY } } }],
                            { useNativeDriver: true }
