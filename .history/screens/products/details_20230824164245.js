...
const ProductDetailScreen = ({ route }) => {
    ...
    const { title, price, images, description, location, inputs, inputsData = {}, _id, user, expert, category, subcategory, furthercategory, ...data } = product;
    ...
    useEffect(() => {
        const getProducts = async () => {
            await axios.get(`/products/${route.params.product._id}`)
                .then(res => {
