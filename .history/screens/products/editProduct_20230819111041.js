...
const EditProductScreen = ({ route }) => {
    ...
    const { category, subcategory, furthercategory, product, expert } = route.params
    ...
    const addProduct = async () => {
        ...
        setLoading(true)
        const res = await updateImages(selectedImages, setLoading)
        ...
        await axios.patch('product/' + product._id, product)
            .then(res => {
