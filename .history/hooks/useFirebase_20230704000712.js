import { doc, setDoc, getDoc, getDocs, serverTimestamp, collection, addDoc, deleteDoc, updateDoc } from "firebase/firestore";
...
export default function useFirebase() {
    ...
    const getDocuments = async (colName, setLoading, where) => {
        try {
            ...
            // let query = collection(db, colName, where)
            // if (where) query = query.where(...where)

            const query = query(collection(db, colName), where);
